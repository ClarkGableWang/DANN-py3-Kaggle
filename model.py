...
class CNNModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.feature.add_module('f_conv2', nn.Conv2d(64, 64, kernel_size=3))
        self.feature.add_module('f_bn2', nn.BatchNorm2d(64))
        self.feature.add_module('f_drop1', nn.Dropout2d())
        self.feature.add_module('f_pool2', nn.MaxPool2d(2))
        self.feature.add_module('f_relu2', nn.ReLU(True))
        self.feature.add_module('f_conv3', nn.Conv2d(64, 64, kernel_size=3))
        ...
        self.class_classifier.add_module('c_drop3', nn.Dropout(p=0.2))
